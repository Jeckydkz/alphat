...
class LINE extends Command {
    ...
    get myBot() {
        const bot = ['u7099fa4af6676fcae8fac00bcc388143','u7099fa4af6676fcae8fac00bcc388143','u7099fa4af6676fcae8fac00bcc388143'];
        return bot; 
    }
    ...
    async textMessage(messages) {
        ...
        this.command(`.tikung ${payload}`,this.kickAll.bind(this));
